package com.lc.manager.aop;

import com.lc.common.utils.IPInfoUtil;
import com.lc.common.utils.ThreadPoolUtil;
import com.lc.manager.annotation.SystemControllerLog;
import com.lc.manager.annotation.SystemServiceLog;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(com.lc.manager.annotation.SystemControllerLog)")
     ...
     * Service层切点,注解方式
     */
    @Pointcut("@annotation(com.lc.manager.annotation.SystemServiceLog)")
